...
<html lang="es">
    <head>
        ...
        <title>Sedes | Barbería B&L</title>
        ...
        <main>
            <div class="sedes-container">
                ...
                <div class="sedes-box">
                    ...
                    <a href="https://www.google.com/maps/search/?api=1&query=Av.+José+Carlos+Mariátegui+2596,+San+Isidro,+Lima" target="_blank" rel="noopener" class="map-link">Ver en el mapa</a>
                </div>
                <div class="sedes-box">
                    <h2>EL AGUSTINO</h2>
                    <div class="images-sedes-grid">
